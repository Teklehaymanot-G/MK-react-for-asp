    ...
    <div>
      <IconButton 
        ...
        <StatusBullet
          ...
          color={statusColors[mm.status]}
          size="sm"
        />
        
        <Typography display="inline" variant="body2">
          {statusLabel(mm.status)}
        </Typography>
      </IconButton>
            ...
            <Typography component='span' style={{display: 'flex'}}>
              <Grid component='span' style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <div className={classes.statusContainer}>
                  ...
                  <StatusBullet
                    className={classes.status}
                    color={statusColors[mm.status === 1 ? 0 : 1]}
                    size="sm"
                  />
                  <Typography display="inline" variant="body2">
                    {statusLabel(mm.status === 1 ? 0 : 1)}
                  </Typography>
                </div>
              </Grid>
            </Typography>
