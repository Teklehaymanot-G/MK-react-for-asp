...
const ChangeStatus = props => {
  ...
  const editMaekel = () => {
    ...
    Axios.put(`${config.LOCATION()}kifil/edit/${kifil.maekel_id}`, {...formStateEdit.values})
      .then(response => {
        if(response.data.success){
          kifil.name = formStateEdit.values.name;
          kifil.location = formStateEdit.values.location;
          kifil.description = formStateEdit.values.description;
          setEditError(false);
