    ...
    <div>
      <IconButton 
        ...
        <StatusBullet
          ...
          color={statusColors[gm.status]}
          size="sm"
        />
        
        <Typography display="inline" variant="body2">
          {statusLabel(gm.status)}
        </Typography>
      </IconButton>
            ...
            <Typography component='span' style={{display: 'flex'}}>
              <Grid component='span' style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <div className={classes.statusContainer}>
                  ...
                  <StatusBullet
                    className={classes.status}
                    color={statusColors[gm.status === 1 ? 0 : 1]}
                    size="sm"
                  />
                  <Typography display="inline" variant="body2">
                    {statusLabel(gm.status === 1 ? 0 : 1)}
                  </Typography>
                </div>
              </Grid>
            </Typography>
...
ChangeStatus.propTypes = {
  ...
  gm: PropTypes.object.isRequired,
};
